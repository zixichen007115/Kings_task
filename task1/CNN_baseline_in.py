...
delect_list = np.empty(1).astype(int)
...
train_sample_idx = np.setdiff1d(train_sample_idx, delect_list)
train_sample_idx = np.random.choice(train_sample_idx,500)
